...
console.log(`Медіана послідовності: ${getMedian(prompt('Input numbers with a space. Find the median').split(' '))}`);
...
console.log(`Видалити парні числа: ${filterEvenNumbers(prompt('Input numbers with a space. Delete even numbers!').split(' '))}`);
